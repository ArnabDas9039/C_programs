...
// hello this is only a test line to test if my visual studio code can automatically wrap text around to the next line. Horizontal scrolling while coding is very annoying.
// Yes Obviously this works and I need to click alt+z
node *head = NULL;
node *link = NULL;
void display()
{
